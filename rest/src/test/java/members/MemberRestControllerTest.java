...
public class MemberRestControllerTest {
    ...
    public void readSingleMember() throws Exception {
        mockMvc.perform(get("/" + userName + "/members/"
                ...
                .andExpect(jsonPath("$.id", is(this.memberList.get(0).getId().intValue())))
                .andExpect(jsonPath("$.uri", is("http://member.com/1/" + userName)))
    ...
    public void readMembers() throws Exception {
        mockMvc.perform(get("/" + userName + "/members"))
                ...
                .andExpect(jsonPath("$[0].id", is(this.memberList.get(0).getId().intValue())))
                .andExpect(jsonPath("$[0].uri", is("http://member.com/1/" + userName)))
                .andExpect(jsonPath("$[0].description", is("A description")))
                .andExpect(jsonPath("$[1].id", is(this.memberList.get(1).getId().intValue())))
                .andExpect(jsonPath("$[1].uri", is("http://member.com/2/" + userName)))
